...
python -m torch.distributed.launch --nproc_per_node=$gpu_no drivers/run_ann_data_gen.py \
 ...
 --model_type rdot_nll \
 --output_dir /home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/ann_data_4 \
 ...
 --end_output_num -1 \
 --ann_chunk_factor 20 \
 --ann_dir /home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/ann_data_4 \
 --load_gen true"

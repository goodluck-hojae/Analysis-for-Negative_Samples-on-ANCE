...
preprocessed_data_dir="/home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/subset_10_outcome/preprocessed_10_data_subset"
...
model_dir="/home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/subset_10_outcome/checkpoints"
# model_ann_data_dir="${model_dir}ann_data/"
model_ann_data_dir="/home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/subset_10_outcome/ann_data"

# pretrained_checkpoint_dir="warmup checkpoint path"
pretrained_checkpoint_dir="/home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/subset_10_outcome/pretrained_bm25"

MASTER_PORT=29501
initial_data_gen_cmd="\
torchrun --master_port=29501 --nproc_per_node=$gpu_no ../drivers/run_ann_data_gen.py --training_dir $model_dir \
...
--per_gpu_eval_batch_size 128 --topk_training 200 --negative_sample 20 \
"

...
##################################### Data Preprocessing ################################
model_dir="/home/hojaeson_umass_edu/hojae_workspace/project/ance/data/30/checkpoints_2_bottom_neg_only"
model_ann_data_dir="/home/hojaeson_umass_edu/hojae_workspace/project/ance/data/30/ann_data_2_bottom_neg_only"
...
--warmup_steps $warmup_steps --logging_steps 300 --save_steps 2000 --optimizer lamb --single_warmup \
"

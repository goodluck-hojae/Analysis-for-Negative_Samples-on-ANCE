...
python -m torch.distributed.launch --nproc_per_node=$gpu_no drivers/run_ann_data_gen.py \
 --training_dir /home/hojaeson_umass_edu/hojae_workspace/project/ance/data/30/checkpoints_random \
 --init_model_dir ${pretrained_checkpoint_dir} \
 --model_type rdot_nll \
 --output_dir /home/hojaeson_umass_edu/hojae_workspace/project/ance/data/30/ann_data_2_random \
 ...
 --ann_dir /home/hojaeson_umass_edu/hojae_workspace/project/ance/data/30/ann_data_2_random \
 "

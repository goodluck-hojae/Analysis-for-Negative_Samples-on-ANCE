...
model_dir="/home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/checkpoints_4_bottom_neg_only"
model_ann_data_dir="/home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/ann_data_4_bottom_neg_only"
...
python -m torch.distributed.launch  --master_port=29501 --nproc_per_node=$gpu_no drivers/run_ann_data_gen.py \
 --training_dir /home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/checkpoints_bottom_neg_only \
 --init_model_dir ${pretrained_checkpoint_dir} \
 --model_type rdot_nll \
 --output_dir /home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/ann_data_4_bottom_neg_only \
 ...
 --bottom_neg true \
 --bottom_only true \
 --ann_dir /home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/ann_data_4_bottom_neg_only"

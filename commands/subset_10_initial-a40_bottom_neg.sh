...
python -m torch.distributed.launch --nproc_per_node=$gpu_no drivers/run_ann_data_gen.py \
 --training_dir /home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/checkpoints_bottom_neg \
 --init_model_dir ${pretrained_checkpoint_dir} \
 --model_type rdot_nll \
 --output_dir /home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/ann_data_4_bottom_neg \
 ...
 --bottom_neg true \
 --load_gen true \
 --ann_dir /home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/ann_data_4_bottom_neg"

...
preprocessed_data_dir=/home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/preprocessed_data #"${base_data_dir}ann_data_${tokenizer_type}_${seq_length}/"
job_name="OSPass512"
pretrained_checkpoint_dir="/home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/outcome/pretrained/checkpoint-150000"
data_type=1
warmup_steps=5000
per_gpu_train_batch_size=32 #8
...
# preprocessed_data_dir="${base_data_dir}ann_data_${tokenizer_type}_${seq_length}/"
# job_name="OSDoc2048"
# pretrained_checkpoint_dir="/home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/outcome/pretrained_bm25"
# data_type=0
# warmup_steps=500
...
##################################### Data Preprocessing ################################
model_dir="/home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/checkpoints_${gpu_no}"
model_ann_data_dir="/home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/ann_data_${gpu_no}"

mkdir ${model_dir}
mkdir ${model_ann_data_dir}
...
--warmup_steps $warmup_steps --logging_steps 100 --save_steps 2000 --optimizer lamb --single_warmup \
"

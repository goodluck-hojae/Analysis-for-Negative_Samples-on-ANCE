...
model_dir="/home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/checkpoints"
# model_ann_data_dir="${model_dir}ann_data/"
model_ann_data_dir="/home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/ann_data"
...
python drivers/run_ann_data_gen.py \
 --training_dir /home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/checkpoints \
 --init_model_dir ${pretrained_checkpoint_dir} \
 --model_type rdot_nll \
 --output_dir /home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/ann_data \
 ...
 --server_port 12345 \
 --end_output_num -1 \
 --ann_dir /home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/ann_data \
 --bottom_neg true \
 --load_gen true" \

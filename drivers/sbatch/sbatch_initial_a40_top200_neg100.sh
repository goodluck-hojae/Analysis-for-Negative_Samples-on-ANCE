...
python -m torch.distributed.launch --nproc_per_node=1 drivers/run_ann_data_gen.py \
 ...
 --model_type rdot_nll \
 --output_dir /home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/outcome/ann_data_top200_neg100 \
 ...
 --server_port 12345 \
 --end_output_num -1 \
 --ann_dir /home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/outcome/ann_data_top200_neg100

...
BASE_DIR=~/646/data/1
nohup python3 -m torch.distributed.launch --master_port=12355 --nproc_per_node=1 run_ann.py \
 --model_type rdot_nll \
 --model_name_or_path ~/646/outcome/pretrained_bm25  \
 --task_name MSMarco \
 --triplet \
 --data_dir ${BASE_DIR}/preprocessed_data \
 --ann_dir ${BASE_DIR}/ann_data \
 --max_seq_length 512 \

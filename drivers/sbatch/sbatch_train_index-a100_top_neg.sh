...
nvidia-smi
echo "subset_run_train_index_top_neg.sh"
...
nohup  sh run_ann_data_gen-a100_top_neg.sh  | tee nohup-index-a100-$SLURM_JOB_ID.out


echo "subset_run_train_index_top_neg.sh finished"
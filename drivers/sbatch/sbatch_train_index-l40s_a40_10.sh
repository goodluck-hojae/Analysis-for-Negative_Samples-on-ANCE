...
nohup python3 -m torch.distributed.launch --master_port=12355 --nproc_per_node=4 drivers/run_ann.py \
 --model_type rdot_nll \
 ...
 --learning_rate 2e-6 \
 --output_dir /home/hojaeson_umass_edu/hojae_workspace/vector_database/ANCE/data/10/checkpoints \
 --warmup_steps 0 \
 --logging_steps 50 \
 --save_steps 500 \
 --single_warmup \

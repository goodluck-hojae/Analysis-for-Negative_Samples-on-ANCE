...
sh ../commands/subset_30_initial-a100_bottom_neg.sh

sh ../commands/subset_30_train-a100_bottom_neg.sh | tee subset_30_train-a100-$SLURM_JOB_ID.out &
 
sh ../commands/subset_30_run_ann_data_gen-a100_bottom_neg.sh  | tee subset_30_run_ann_data_gen-a100-$SLURM_JOB_ID.out


echo "commands/sbatch_initial_train_subset_30_bottom_neg.sh"

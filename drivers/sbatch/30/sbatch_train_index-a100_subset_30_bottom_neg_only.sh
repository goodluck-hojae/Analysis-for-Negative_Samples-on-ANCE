...
nvidia-smi
echo "sbatch_train_index-a100_subset_30_bottom_neg_only.sh"
...
sh ../commands/subset_30_train-a100_bottom_neg_only.sh | tee subset_30_train-a100-$SLURM_JOB_ID.out &
 
sh ../commands/subset_30_run_ann_data_gen-a100_bottom_neg_only.sh  | tee subset_30_run_ann_data_gen-a100-$SLURM_JOB_ID.out


echo "sbatch_train_index-a100_subset_30_bottom_neg_only.sh finished"
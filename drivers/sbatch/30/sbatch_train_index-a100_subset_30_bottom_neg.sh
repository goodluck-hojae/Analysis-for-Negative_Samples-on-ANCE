...
nvidia-smi
echo "sbatch_train_index-a100_subset_10_bottom_neg.sh"
...
nohup sh ../commands/subset_30_train-a100_bottom_neg.sh | tee subset_10_train-a100-$SLURM_JOB_ID.out &
 
sh ../commands/subset_30_run_ann_data_gen-a100_bottom_neg.sh  | tee subset_10_run_ann_data_gen-a100-$SLURM_JOB_ID.out


echo "sbatch_train_index-a100_subset_10_bottom_neg.sh finished"
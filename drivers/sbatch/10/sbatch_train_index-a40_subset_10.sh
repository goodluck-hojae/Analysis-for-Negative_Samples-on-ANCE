...
sh ../commands/subset_10_train-a40.sh | tee subset_10_train-a40-$SLURM_JOB_ID.out &
 
sh ../commands/subset_10_run_ann_data_gen-a40.sh  | tee subset_10_run_ann_data_gen-a40-$SLURM_JOB_ID.out

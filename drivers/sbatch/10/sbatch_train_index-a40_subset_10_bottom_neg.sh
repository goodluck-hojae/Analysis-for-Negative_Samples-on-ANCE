...
nvidia-smi
echo "sbatch_train_index-a40_subset_10_bottom_neg.sh"
...
sh ../commands/subset_10_train-a40_bottom_neg.sh | tee subset_10_train-a40-$SLURM_JOB_ID.out &
 
sh ../commands/subset_10_run_ann_data_gen-a40_bottom_neg.sh  | tee subset_10_run_ann_data_gen-a40-$SLURM_JOB_ID.out


echo "sbatch_train_index-a40_subset_10_bottom_neg.sh finished"
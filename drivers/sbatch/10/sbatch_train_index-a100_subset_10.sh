...
nohup sh ../commands/train-a100_subset_10.sh | tee train_index-a100_subset_10-$SLURM_JOB_ID.out &
 
nohup  sh ../commands/run_ann_data_gen-a100_subset_10.sh  | tee run_ann_data_gen-a100_subset_10-$SLURM_JOB_ID.out &
